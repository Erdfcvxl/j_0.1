 ...
 */
class UserSearchNew extends User
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['tu','ve','ve2','se','f','sl','i', 'l', 'rs', 'ts', 'vip', 's', 'miestas', 'svoris1', 'svoris2', 'amzius1', 'amzius2', 'ugis1', 'ugis2', 'moteris', 'vyras', 'username', 'auth_key', 'password_hash', 'password_reset_token', 'vyras', 'moteris', 'email', 'reg_step', 'avatar', 'lastOnline'], 'safe'],
        ];
    }
    ...
    public function search($params, $top)
    {
