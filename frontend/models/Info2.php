 ...
 * @property User $user
 */
class Info2 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['u_id', 'amzius_tarp', 'iesko', 'suzinojo', 'gimtine', 'tautybe', 'religija', 'statusas', 'pareigos', 'uzdarbis', 'orentacija', 'tikslas', 'miestas', 'grajonas', 'drajonas', 'kalba', 'metai', 'menuo', 'diena', 'issilavinimas', 'ugis', 'svoris', 'sudejimas', 'plaukai', 'akys', 'stilius', 'zodis'], 'required'],
            [['u_id'], 'integer'],
    ...
    {
        return $this->hasMany(Likes::className(), ['user_id' => 'u_id']);
    }
