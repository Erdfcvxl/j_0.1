...
if($arDraugas === false){
    Yii::$app->session->setFlash('error', 'Tik draugai gali pamatyti albumą');
...
<div class="row" style="margin-top: 5px; padding-bottom: 70px;">
    ...
    <div class="col-xs-9" >
    	<div class="container" style="width:100%; background-color: #e8e8e8; min-height: 150px; font-size: 12px; text-align: left; padding: 10px 10px;">
