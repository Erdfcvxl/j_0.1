...
<div class="row" style="margin-bottom: 7px; background-color: #e3f1d0; ">
    ...
    <a href="<?= Url::to(['member/fotos', 'id' => $_GET["id"]])?>"><div class="col-md-5ths ptop main <?php echo($puslapis == "fotos" || $puslapis == "fotosalbumview")? "main_active" : "" ?>"><img src="/css/img/icons/<?php echo($puslapis == "fotos" || $puslapis == "fotosalbumview")? "baltas_" : "" ?>fotoaparatas.png" /><br>Nuotraukos</div></a>
