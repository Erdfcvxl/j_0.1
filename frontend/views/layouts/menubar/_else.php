...
<div class="row" style="margin-bottom: 7px; background-color: #e3f1d0; ">
    ...
    <a href="#" style="opacity: 0.5"><div class="col-md-5ths ptop main <?php echo($puslapis == "statistika")? "main_active" : "" ?>"><img src="/css/img/icons/<?php echo($puslapis == "statistika")? "baltas_" : "" ?>zvaigzdute.png" /><br>Statistika</div></a>
</div>
