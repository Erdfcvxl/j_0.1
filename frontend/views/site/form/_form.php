            ...
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8 vcenter top">
                    <div class="row" style="padding: 0 15px 0 15px">
                        <div class="col-xs-4"
                             style="padding: 0;"><?= $form->field($model_info, 'metai')->dropDownList($year, ['class' => 'reg_dropbox', 'style' => 'padding-left: 5px;'])->label(false); ?> </div>
                        <div class="col-xs-4"
                             style="padding: 0 0 0 5px;"><?= $form->field($model_info, 'menuo')->dropDownList($month, ['class' => 'reg_dropbox', 'style' => 'padding-left: 5px;'])->label(false); ?> </div>
                        <div class="col-xs-4"
                             style="padding: 0 0 0 5px;"><?= $form->field($model_info, 'diena')->dropDownList($day, ['class' => 'reg_dropbox', 'style' => 'padding-left: 5px;'])->label(false); ?> </div>
                    </div>
                </div>
            </div>
...
<?php elseif ($re == 3): ?>
        ...
        <div class="col-xs-12 col-xs-offset-0 col-sm-6 col-sm-offset-3 top" id="atstaskas" style="margin-top: 15px;">
            <div class="row">
                <div class="col-xs-6 col-sm-7 upload_bg vcenter" style="padding: 8px 0 8px 8px">
                    <div class="col-xs-3"
                         style="padding: 0px; position: relative; z-index: 1;"><?= $form->field($UploadForm, 'file', [
                    ...
                    <div class="row" style="position: absolute; left: 15px; bottom: -40px;">
                        ...
                        <label for="c1" style="font-family: OpenSans; cursor: pointer; font-weight: normal;">
                            <span></span>Praleisti šį žingsnį</label>
                    </div>
                </div>
                <div class="col-xs-5 col-xs-offset-1 col-sm-offset-0 vcenter">
                    <div class="img_container">
                        <div id="no_av_place"
                             style="overflow: hidden; position: relative; top: 10px; left: 10px; width: 160px; height: 160px; background-image: url('/css/img/icons/no_avatar.png');">
    ...
    <script type="text/javascript">
        ...
        $('#avatar').load(function () {
            ...
            if (w_i == h_i) {
            ...
            } else if (aspect_ratio_i.toFixed(1) > 1) {
                console.log("variantas 1"); //variantas 1
                ...
                console.log("variantas2");//variantas 2
...
<?php elseif ($re == 4): ?>
    ...
    <div class="container" style="width:90%; font-family: OpenSans">
        <div class="row top">
            ...
            <div class="col-xs-8" style="padding-left: 0;">Keletas žodžių visiems(-oms) tavo profilio lankytojams
                (-oms)
            </div>
        </div>
        <div class="row">
            <div class="col-xs-4">
                <div id="no_av_place"
                     style="overflow: hidden; position: relative; float: right; width: 160px; height: 160px; background-image: url('/css/img/icons/no_avatar.png');">
            ...
            <div class="col-xs-8">
                <div
                    class="row"><?= $form->field($model_info, 'zodis')->textarea(['style' => 'height: 129px'])->label(false); ?></div>
                <div class="row top2"><input type="checkbox" id="c1" name="skip"/><label for="c1"
                                                                                         style="font-family: OpenSans; cursor: pointer; font-weight: normal;"><span></span>Praleisti
                        šį žingsnį</label></div>
            </div>
        </div>
    ...
    if (array_search(3, $c_steps)): ?>
        ...
        <script type="text/javascript">
            ...
            $('#avatar').attr('src', "/uploads/531B"+<?= $id; ?>+
            "Iav." + extension
            )
            ;
