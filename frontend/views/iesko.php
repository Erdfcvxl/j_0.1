    	...
    	<div class="container iesko" style="width:100%; background-color: #e8e8e8; min-height: 150px; text-align: left; padding: 10px 30px;">
    		<?php
    			...
    			foreach ($model->attributes as $key => $attribute): 
    				...
    				if($attribute != "" && $key != "id" && $key != "u_id" ):
                        $yra = true;
    		?>

    					<div class="row">
	    					<div class="col-xs-6 addLine">
    		...
    		<?php 	
                ...
                if(!$yra): 
                    ?><div class="alert alert-info">Kol kas <b><?= $user->username; ?></b> nepateikė šios informacijos</div><?php
                endif;

                else:
            ?>
                <div class="alert alert-info">Kol kas <b><?= $user->username; ?></b> nepateikė šios informacijos</div>
            <?php
                endif; 
    		?>
        </div>
