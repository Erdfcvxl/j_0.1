...
use frontend\models\Payseracallback;
use Yii;
use yii\helpers\Url;
...
//                        $order->save();
//
//                        echo 'OK abonementas vartototojui '. Yii::$app->user->identity->username .' sėkmingai pratęstas iki: '. date ("Y-m-d H:i", $vartotojas->expires;
//                    }
//                    else
