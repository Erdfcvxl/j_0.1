	...
	<div class="row">
		...
		<div class="col-xs-12 col-lg-9">
			...
			<div class="alert alert-warning">
				Jei ketinate grįžti atgal, o gavėjai buvo vesti rankiniu būdų - nusikopijuokite gavėjus, nes formą reikės pildyti iš naujo.
			</div>
		</div>
...
<?php $url = Yii::$app->urlManager->createUrl('/site/fmmsend'); ?>
